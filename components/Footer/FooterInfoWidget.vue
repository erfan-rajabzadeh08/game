<template>
    <div class="flex flex-col text-right mr-10	">
        ...
        <!-- Text Start -->
        <p dir="rtl" class="text-start">گیم نت <strong>club80</strong> .با ارائه پلی استیشن 5 و تلویزیون 4K  ومحیطی پر هیجان همراه با کافی شاپ آماده ساخت یک روز رویایی برای شماست</p>
        <!-- Text End -->
